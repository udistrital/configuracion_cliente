...
angular.module('javierApp')
  .controller('menuCtrl', function($location, $http, $scope, token_service, configuracionRequest) {
    var ctrl = this;
    var paths = [];
    ...
    $http.get('http://10.20.0.254/configuracion_api/v1/menu_opcion_padre/ArbolMenus/Administrador configuración/Configuración)
